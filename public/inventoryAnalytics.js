    ...
    .then(data => {
      ...
      new Chart(salesEl, {
        ...
        data: {
          labels,
          datasets: [
            { label: 'Sales Revenue', data: salesData, borderColor: 'blue', fill: false },
            { label: 'Ingredient Cost', data: costData, borderColor: 'red', fill: false }
          ]
        },
      ...
      new Chart(usageEl, {
        ...
        data: {
          labels: usageLabels,
          datasets: [{ label: 'Total Used', data: usageData, backgroundColor: 'green' }]
        },
        options: { scales: { y: { beginAtZero: true } } }
      });
    })
